...
public class CarGame extends JFrame implements KeyListener,ActionListener
{
	...
	tree1=new ImageIcon("./assets/meteor1.png");

	tree1.paintIcon(this, g, 0, tree1ypos);
	num1=random.nextInt(500);
	tree1ypos+=50;
	
	tree2=new ImageIcon("./assets/meteor2.png");
	tree2.paintIcon(this, g, 0,tree2ypos );
	tree2ypos+=50;
	
	tree3=new ImageIcon("./assets/planet.png");
	...
	if(tree6ypos>700)
	{
		...
		car=new ImageIcon("./assets/gamespaceship.png");
		...
		// opposite car
		car1=new ImageIcon("./assets/enemyspaceship1.png");
		car2=new ImageIcon("./assets/enemyspaceship2.png");
		car3=new ImageIcon("./assets/enemyspaceship3.png");
...
//			}
		...
		if(y1pos<ypos && y1pos+84>ypos && carxpos[cxpos1]==xpos)
		{
		gameover=true;	
		}
		if(y2pos<ypos && y2pos+103>ypos && carxpos[cxpos2]==xpos)
			
		{
		gameover=true;	
		}
		if(y3pos<ypos  && y3pos+107>ypos && carxpos[cxpos3]==xpos)
		{
		gameover=true;	
		}
		if(gameover)
